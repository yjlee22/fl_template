...
class DatasetObject:
    ...
    def set_data(self):
        ...
        if not (os.path.exists(client_x_path) and os.path.exists(client_y_path) and 
            ...
            train_dataset = DataClass(split='train', transform=transform, download=True, as_rgb=True, size=64)
            test_dataset = DataClass(split='test', transform=transform, download=True, as_rgb=True, size=64)
